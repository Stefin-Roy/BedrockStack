...
impl XhciRegisters {
    pub fn new(phys_base: u64, dma: &'static dyn DmaAllocator) -> Result<Self, &'static str> {
...
impl Erst {
    pub fn new(dma: &'static dyn DmaAllocator) -> Result<Self, &'static str> {
...
impl EventRing {
    pub fn new(dma: &'static dyn DmaAllocator, erst_seg_va: u64) -> Result<Self, &'static str> {
        let trb_count = 256;
